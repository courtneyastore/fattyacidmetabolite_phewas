...
metabolite_df <- metabolite_df[c('ID','p23444_zscore')]
metabolite_df <- metabolite_df[!is.na(metabolite_df$p23444_zscore), ]
...
ggsave("/Users/courtneyastore/Dropbox (GaTech)/metabolitexenvironment_disease_project/figures/PRSxMetabolite/O3FA_Cholelithiasis_PGSPrev_plt.pdf",height = 8,width = 8,dpi = 300,limitsize = FALSE)
