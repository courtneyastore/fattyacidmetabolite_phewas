...
#------------------ Non-genetic O3FA--------------------------
o3fa_bmi_genetic_df <- as.data.frame(fread("/Users/courtneyastore/Dropbox (GaTech)/metabolitexenvironment_disease_project/processing_files/BMIWHR_results/O3FAzscoreObesityBMI_Interaction_logisticRegression_MRsupportdiseases.tsv"))
...
o3fa_whr_genetic_df <- as.data.frame(fread("/Users/courtneyastore/Dropbox (GaTech)/metabolitexenvironment_disease_project/processing_files/BMIWHR_results/O3FAzscoreObesityWHR_Interaction_logisticRegression_MRsupportdiseases.tsv"))
