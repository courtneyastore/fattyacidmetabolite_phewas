...
out_file = "/storage/home/hcoda1/1/castore3/p-ggibson3-0/PUFA_PheWAS_Frontiers/result_files/11_28_2023_Phecodes_Zscore_DHA_age_agesquare_sex_10PCS_glmresults_"
out_file = paste0(out_file,iter_,".tsv")

#files_lst <- list.files(path=args[1], pattern=".tsv", all.files=TRUE,full.names=TRUE)

master_df <- as.data.frame(fread("/storage/home/hcoda1/1/castore3/p-ggibson3-0/PUFA_PheWAS_Frontiers/processed_data/p23450_covariates_bodyweight_normalized.tsv",sep="\t"))
...
for (phecode_id in files_lst){
    ...
    if (n_case_samples < 50){
        ...
        glm_i <- glm(disease_status ~ p23450_median_zscore + p21022 + p21022_square + p31 + p22009_a1 + p22009_a2 + p22009_a3 + p22009_a4 + p22009_a5 + p22009_a6 + p22009_a7 + p22009_a8 + p22009_a9 + p22009_a10, family = "binomial", data = case_control_cohort_df)
